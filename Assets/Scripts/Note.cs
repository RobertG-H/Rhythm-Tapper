...
public class Note : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SongManager.GetComponent<SongManager>().getBeat() % 1 == 0 && SongManager.GetComponent<SongManager>().getBeat() != prevBeat)
        {
        ...
        if (SongManager.GetComponent<SongManager>().getBeat() != _hitBeat && SongManager.GetComponent<SongManager>().getBeat() % 1 == 0)
        {
            _hit = false;
            _hitable = true;
        }
